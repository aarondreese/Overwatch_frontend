...
import { PencilSquareIcon, PlusCircleIcon, XMarkIcon, MagnifyingGlassIcon } from "@heroicons/react/24/solid";
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-lg border border-gray-200">
            ...
            {/* Domain Tab Content */}
            <div className={`${selectedTabName === "domain-tab" ? "" : "hidden"}`}>
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-800">
                      {selectedSystemID === -1
                        ? "Domains"
                        : `Domains for ${selectedSystem?.systemName || "Unknown System"}`}
                    </h3>
                ...
                {selectedSystemID === -1 ? (
                  <div className="text-center py-12">
                    ...
                    <h4 className="text-lg font-medium text-gray-600 mb-2">No Source System Selected</h4>
                    <p className="text-gray-500">Please select a source system from the table above to view and manage its domains.</p>
                  </div>
                ) : !selectedSystem?.domains || selectedSystem.domains.length === 0 ? (
                  <div className="text-center py-12">
                    <div className="text-gray-400 mb-4">
                      <svg className="mx-auto h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2M4 13h2m0 0V9a2 2 0 012-2h2m5 2v4m0 0h2a2 2 0 002-2V9a2 2 0 00-2-2h-2m0 4V7" />
                      </svg>
                    </div>
                    <h4 className="text-lg font-medium text-gray-600 mb-2">No Domains Found</h4>
                    <p className="text-gray-500 mb-6">This source system doesn't have any domains yet. Create your first domain to get started.</p>
                    <button
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {selectedSystem.domains.map((domain) => (
                          <tr key={domain.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-500">
                                {domain.createdDate ? new Date(domain.createdDate).toLocaleDateString() : "N/A"}
                              </div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                              <div className="flex gap-2 justify-end">
                                <button className="text-blue-600 hover:text-blue-900" title="Edit Domain">
                                  <PencilSquareIcon className="h-4 w-4" />
                                </button>
                                <button className="text-red-600 hover:text-red-900" title="Delete Domain">
            ...
            {/* Synonym Tab Content */}
            <div className={`${selectedTabName === "synonym-tab" ? "" : "hidden"}`}>
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-800">
                      {selectedSystemID === -1
                        ? "Synonyms"
                        : `Synonyms for ${selectedSystem?.systemName || "Unknown System"}`}
                    </h3>
                    <p className="text-sm text-gray-600">
                      {selectedSystemID === -1
                ...
                {selectedSystemID === -1 ? (
                  <div className="text-center py-12">
                    ...
                    <h4 className="text-lg font-medium text-gray-600 mb-2">No Source System Selected</h4>
                    <p className="text-gray-500">Please select a source system from the table above to view and manage its synonyms.</p>
                  </div>
                ) : !selectedSystem?.synonyms || selectedSystem.synonyms.length === 0 ? (
                  <div className="text-center py-12">
                    <div className="text-gray-400 mb-4">
                      <svg className="mx-auto h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                    ...
                    <h4 className="text-lg font-medium text-gray-600 mb-2">No Synonyms Found</h4>
                    <p className="text-gray-500 mb-6">This source system doesn't have any synonyms yet. Use the "Add Synonym" button above to get started.</p>
                  </div>
                ) : (
                  <div>
                    {/* Search Bar */}
                    <div className="mb-6 flex gap-4 items-center">
                      ...
                      <div className="flex gap-2 items-center">
                        <span className="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm">
                          {filteredSynonyms.length} of {selectedSystem.synonyms.length} synonyms
                        </span>
                        {synonymSearchTerm && (
                          <button
                    ...
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                          <tr>
                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Synonym Name</th>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {filteredSynonyms.length === 0 ? (
                              ...
                              <td colSpan="5" className="px-6 py-8 text-center">
                                <div className="text-gray-500">
                                  {synonymSearchTerm ? (
                                    <>
                                      <div className="mb-2">
                                        No synonyms found matching "{synonymSearchTerm}"
                                      </div>
                                      <button
                            ...
                            filteredSynonyms.map((synonym) => (
                              <tr key={synonym.systemID} className="hover:bg-gray-50">
                                <td className="px-6 py-4 whitespace-nowrap">
                                  <div className="flex items-center">
                                    <div className="h-8 w-8 rounded-full bg-purple-100 flex items-center justify-center mr-3">
                                      <span className="text-sm font-medium text-purple-600">
                                        {synonym.synonymName.charAt(0).toUpperCase()}
                                      </span>
                                    </div>
                                    <div>
                                      <div className="text-sm font-medium text-gray-900">{synonym.synonymName}</div>
                                      <div className="text-sm text-gray-500">ID: {synonym.systemID}</div>
                                    </div>
                                  </div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                                    synonym.columnName ? "bg-blue-100 text-blue-800" : "bg-green-100 text-green-800"
                                  }`}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                  <div className="text-sm text-gray-900">
                                    {synonym.tableName && (
                                      <div className="font-medium">{synonym.tableName}</div>
                                    )}
                                    {synonym.columnName && (
                                      <div className="text-xs text-gray-500">{synonym.columnName}</div>
                                    )}
                                  </div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                  <div className="flex gap-2 justify-end">
                                    <button className="text-blue-600 hover:text-blue-900" title="Edit Synonym">
                                      <PencilSquareIcon className="h-4 w-4" />
                                    </button>
                                    <button className="text-red-600 hover:text-red-900" title="Delete Synonym">
                                      <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                      </svg>
                                    </button>
            ...
            <div className={`${selectedTabName === "dqemail-tab" ? "" : "hidden"}`}>
              <div className="p-6">
                <div className="text-center py-12">
                  <div className="text-gray-400 mb-4">
                    <svg className="mx-auto h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <h4 className="text-lg font-medium text-gray-600 mb-2">DQ Emails</h4>
                  <p className="text-gray-500">Data Quality email configuration will be available soon.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <form onSubmit={handleSubmitDomain((data) => handleDomainFormSubmit(data))} className="space-y-4">
            <input
              type="hidden"
            ...
            <div>
              ...
              <input
                ...
                {...registerDomain("DomainName", { required: "Domain name is required" })}
              />
              {errorsDomain.DomainName && (
                <p className="mt-1 text-sm text-red-600">{errorsDomain.DomainName.message}</p>
              )}
            </div>
        ...
        >
          <form onSubmit={handleSubmitSynonym((data) => handleSynonymFormSubmit(data))} className="space-y-4">
            <input
              type="hidden"
              value={selectedSystem?.id}
            ...
            />
            <div>
              <label htmlFor="SynonymName" className="block text-sm font-medium text-gray-700 mb-1">
                Synonym Name *
              </label>
              <input
                type="text"
                ...
                {...registerSynonym("SynonymName", { required: "Synonym name is required" })}
              />
              {errorsSynonym.SynonymName && (
                <p className="mt-1 text-sm text-red-600">{errorsSynonym.SynonymName.message}</p>
              )}
            </div>
            <div>
              ...
              <input
                ...
                {...registerSynonym("TableName", { required: "Table name is required" })}
              />
              {errorsSynonym.TableName && (
                <p className="mt-1 text-sm text-red-600">{errorsSynonym.TableName.message}</p>
              )}
            </div>
            <div>
              <label htmlFor="ColumnName" className="block text-sm font-medium text-gray-700 mb-1">
                Column Name
                <span className="text-xs text-gray-500 ml-2">(Optional - leave blank for table-level synonym)</span>
              </label>
              <input
                type="text"
                id="ColumnName"
        ...
        >
          <form onSubmit={handleSubmitSourceSystem((data) => handleSourceSystemFormSubmit(data))} className="space-y-4">
            <div>
              ...
              <input
                ...
                {...registerSourceSystem("SystemName", { required: "System name is required" })}
              />
              {errorsSourceSystem.SystemName && (
                <p className="mt-1 text-sm text-red-600">{errorsSourceSystem.SystemName.message}</p>
              )}
            </div>
            <div>
              <label htmlFor="LinkedServerName" className="block text-sm font-medium text-gray-700 mb-1">
                Linked Server Name
            ...
            <div>
              <label htmlFor="SourceDatabaseName" className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <input
                ...
                {...registerSourceSystem("SourceDatabaseName", { required: "Database name is required" })}
              />
              {errorsSourceSystem.SourceDatabaseName && (
                <p className="mt-1 text-sm text-red-600">{errorsSourceSystem.SourceDatabaseName.message}</p>
              )}
            </div>
            <div>
              <label htmlFor="SourceSchemaName" className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <input
                ...
                {...registerSourceSystem("SourceSchemaName", { required: "Source schema is required" })}
              />
              {errorsSourceSystem.SourceSchemaName && (
                <p className="mt-1 text-sm text-red-600">{errorsSourceSystem.SourceSchemaName.message}</p>
              )}
            </div>
            <div>
              <label htmlFor="TargetSchemaName" className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <input
                ...
                {...registerSourceSystem("TargetSchemaName", { required: "Target schema is required" })}
              />
              {errorsSourceSystem.TargetSchemaName && (
                <p className="mt-1 text-sm text-red-600">{errorsSourceSystem.TargetSchemaName.message}</p>
              )}
            </div>
            <input
              type="hidden"
            ...
            <div className="flex gap-3 pt-4">
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded transition-colors duration-200"
              >
                {selectedSystem ? "Update Source System" : "Create New Source System"}
              </button>
              <button
                type="button"
                className="bg-gray-300 hover:bg-gray-400 text-gray-700 font-medium py-2 px-4 rounded transition-colors duration-200"
